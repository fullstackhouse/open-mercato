...
| `delivery/` | When scheduling delivery/retry attempts — exponential backoff with jitter, shared by the webhooks and push delivery pipelines | `@open-mercato/shared/lib/delivery/retry` (`calculateBackoffDelayMs`) |
