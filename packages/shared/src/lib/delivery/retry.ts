 ...
 * same instant (thundering herd). Shared by the webhooks and push delivery pipelines so both use
 * identical backoff semantics instead of hand-rolling their own.
 */
