...
| [Order Edit-Guard System-of-Record Bypass](2026-07-20-order-edit-guard-system-of-record-bypass.md) | 2026-07-20 | Order Edit-Guard System-of-Record Bypass | `systemActor`-keyed bypass of the order customer/address edit-status guards for trusted server-side (system-of-record) writes |
